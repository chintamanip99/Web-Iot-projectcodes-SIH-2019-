...
$result=mail("chintamanip99@gmail.com","just","jjhghg","cmp15071999@iotbasedproj.dx.am");
echo $result;
...
$query2 = "SELECT MAX(id) AS max FROM machine1";

$r2=mysqli_query($link,$query2);
$row = mysqli_fetch_array($r2);
$MAX = $row['max'];
//echo $MAX;
$query3 ="SELECT * FROM machine1 where id<=$MAX AND id>$MAX-21";
...
$qwe1="SELECT `ipower` FROM `ideal1` WHERE 1";
...
<div class="w3-container">
  <h2><font color="white">Data readings of Machine 1</font></h2>
